...
export const NAVIGATE_PAGE_IN_HISTORY = 'NAVIGATE_PAGE_IN_HISTORY_EFFECT';
...
export const DISPLAY_WEBVIEW_CONTEXT_MENU = 'DISPLAY_WEBVIEW_CONTEXT_MENU_EFFECT';
export const PIN_TAB = 'PIN_TAB_EFFECT';
export const UNPIN_TAB = 'UNPIN_TAB_EFFECT';

// UI effects

export const SET_APPLICATION_ACTIVE_ELEMENT = 'SET_APPLICATION_ACTIVE_ELEMENT_EFFECT';
...
export const CONFIRM_DEFAULT_BROWSER = 'CONFIRM_DEFAULT_BROWSER_EFFECT';
