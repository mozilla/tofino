...
describe('link clicking', function() {
  ...
  it('can click a link in a page', async function() {
    ...
    expect(selectors.getPages(initialState).length).toEqual(STARTING_TAB_COUNT,
                                                            'Have one tab to start.');
  ...
  it('can modified-click a link in a page and open a background tab', async function() {
    const initialState = await Driver.getReduxState();
    expect(selectors.getPages(initialState).length).toEqual(STARTING_TAB_COUNT,
                                                            'Have one tab to start.');
